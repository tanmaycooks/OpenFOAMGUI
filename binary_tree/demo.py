...
def run_demo():
    ...
    # L = CTO Branch
    add_node(root, "L", "CTOoo")
    add_node(root, "LL", "VPEngr")
    add_node(root, "LR", "234")
    ...
    link = f"http://localhost:5000/?load={encoded_path}"
    
    # Draw Box
    border_len = len(link) + 4
    print(f"\n    \033[1;36m{'+' + '-' * border_len + '+'}\033[0m")
    print(f"    \033[1;36m|  {link}  |\033[0m")
    print(f"    \033[1;36m{'+' + '-' * border_len + '+'}\033[0m\n")
